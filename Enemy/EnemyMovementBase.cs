...
public abstract class EnemyMovementBase : MonoBehaviour
{
    ...
    [Tooltip("Marcar si el sprite inicial mira hacia la izquierda.")]
    ...
    /// <summary>
    /// Pausa o reanuda el movimiento intencional (ej. horizontal),
    /// pero permite que otras fuerzas (como flotar) sigan activas.
    /// </summary>
    public virtual void HaltIntentionalMovement(bool halt)
    {
        // La clase base no hace nada, las clases hijas lo implementarán.
    }
    ...
    protected virtual void UpdateSpriteDirection()
    {
        ...
        // --- LÓGICA MODIFICADA ---
        float facingSign = startsFacingLeft ? -1f : 1f;

        Vector3 scale = transform.localScale;
        // Se multiplica por el signo de la dirección del movimiento
        scale.x = Mathf.Abs(scale.x) * Mathf.Sign(moveDirection.x) * facingSign;
